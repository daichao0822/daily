...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" >
    ...
    <td height="30" colspan="2" align="center" ><table width="100%" border="1" cellspacing="1" cellpadding="1" >
        ...
        for(int i=0;i<dailys.size();i++){
         %>
		  ...
		  <td><div align="center">项目日报</div></td>
		  ...
		  <td><div align="center"><a href="/daily/DailyCheckServlet?flag=2&did=<%=dailys.get(i).getG_intDailyId() %>">详细</a></div></td>
		</tr>
        <%} 
		%>
      </table></td>
  ...
  <tr>
   ...
   <tr>
   <td align="center"><font size="+1" color="#FF0000">本部门没有任何待审阅日报</font></td>
   </tr>
  <%
  }%>
</table>
