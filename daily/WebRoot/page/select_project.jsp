...
String strName=name.getUserName(con,intProjectManager);//将用户ID转换成用户名%>
<%=strName %></td>
 ...
 <table width="100%">
<tr>
<td align="center"><input type="button" name="button" value="确定" onClick="check()" />
<input type="button" value="关闭" onClick="closeWindow()" />
 ...
 </table><!-- 如果list=null，则在此结束上一个table,此标志不属于多余 -->
 <table width="100%">
 <tr>
