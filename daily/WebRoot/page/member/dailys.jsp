<%@ page contentType="text/html; charset=gb2312" language="java" import="java.sql.*" import="java.util.List,com.dao.*" import="com.bean.Daily" import="com.bean.User" errorPage="" %>
	...
	<head>
		...
		<base target="_self">
			<link rel="stylesheet" type="text/css"
				href="page/member/skin/css/base.css" />
			<link rel="stylesheet" type="text/css"
				href="page/member/skin/css/main.css" />
			<style type="text/css">
<!--
body {
...
<body background="../images/login_07.gif">
    ...
    <td height="30" colspan="2" align="center" ><table width="100%" border="1" cellspacing="1" cellpadding="1" >
        ...
        for(int i=0;i<dailys.size();i++){
         %>
		  ...
		  <td><div align="center"><a href="/daily/DailyQueryForMemberServlet?flag=1&dailyID=<%=dailys.get(i).getG_intDailyId() %>">详细</a></div></td>
		</tr>
        <%} 
		%>
      </table></td>
