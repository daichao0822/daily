<%@ page contentType="text/html; charset=gb2312" language="java" import="java.sql.*,com.bean.*" import="java.util.*" import="com.bean.Memo" errorPage="" %>
...
User user=new User();
if((session.getAttribute("userInfo")==null)||(session.getAttribute("userInfo")==null)){
response.sendRedirect("http://localhost/daily/page/session_error.jsp");
return;
}
memo=(List<Memo>)session.getAttribute("memo");
