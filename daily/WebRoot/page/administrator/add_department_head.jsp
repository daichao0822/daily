...
<table width="97%" align="center" border="0" cellpadding="4"
			...
			<tr>              
                <td width="14%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif"> 部门ID</td>                         
                <td width="26%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif"> 部门名称</td>                         
                <td width="15%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">部门长</td>
                <td width="45%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">部门描述</td>
