...
String str_userID=request.getParameter("id");
%>
<form action="AddNewUserServlet?flag=22" method="post" onsubmit="return check()">
<table width="97%" align="center" border="0" cellpadding="4"
			...
			<tr>              
                ...
                <td width="8%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">性别</td>
                <td width="18%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">密码</td>
                <td width="19%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">再次输入密码</td>
                <td width="9%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">所属部门</td>
                <td width="20%" align="center"background="page/head_of_department/skin/images/frame/wbg.gif">邮箱</td>
            </tr>

            <tr bgcolor="#FFFFFF">
                <td align="center"><%=str_userID %><input type="hidden" name="userID" value="<%=str_userID %>" /> </td>
                ...
                <select name="departmentID" id="departmentID">
					...
					%>
                    <option value="<%=dep.get(i).getG_intDepartmentId() %>"><%=dep.get(i).getG_strDepartmentName() %></option>
					<%}
					}
					else{
					%>
					<option value="-1">没有部门</option>
					<%
					}
					%>
                </select></td>
