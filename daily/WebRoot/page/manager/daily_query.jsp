...
function SelectProject(manager) {
	window
			.open(
					"page/manager/select_project.jsp?u=" + manager,
					"selectProject",
...
if(projectName==""){
		...
		window.open("page/manager/select_task.jsp?pid="+projectID,"selectTask","directories=no,left=500,top=250,height=250,width=550,location=yes,menubar=no,resizable=yes,scrollbars=yes,status=yes,toolbar=no",false);
	}
}
...
String str_manager=request.getParameter("u");
%>
		<br />
		<table width="100%">
			<tr>
				<td align="center">
					<strong><font color="#669900" size="+2">日报查询</font> </strong>
				</td>
			</tr>
		</table>
		<br />
		<form id="form1" name="form1"
			action="DailyQueryForMngServlet" method="post" onsubmit="return CheckProject()">
...
%><option value="-1">没有项目供选择</option><%
 ...
 %>
		...
		<form id="form2" name="form2"
			action="DailyQueryForMngServlet"
				...
				<tr>
					...
					<td width="81%" align="left">
						...
						<input type="button" value="选择项目"
							onclick="SelectProject(<%=str_manager%>)" />
						&nbsp;
...
%><option value="-1">没有项目人员供选择</option><%
 ...
 %>
						...
						<input type="submit" value="查询" />
						&nbsp;&nbsp;
						<font color="#FF0000" size="-1">仅能查询负责项目下的项目人员日报</font>
					</td>
				</tr>
			</table>
			<br />
