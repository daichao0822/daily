...
<input type="hidden" id="hidden" value="${sessionScope.userInfo.g_intUserId}" /><!-- 隐藏项目经理ID供check()函数判断时使用-->
</td>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td align="center"><font color="#FF0000">目前没有已暂停项目</font></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
