...
<td align="center"><a href="ProjectDetailForMngServlet?flag=1&id=<%=list.get(i).getG_intProjectId() %>">详细</a></td>
</tr>
<%}
} 
}
...
<td align="center"><a href="ProjectDetailForMngServlet?flag=2&id=<%=list.get(i).getG_intProjectId() %>">详细</a></td>
</tr>
<%}
} 
}
...
<td align="center"><a href="ProjectDetailForMngServlet?flag=3&id=<%=list.get(i).getG_intProjectId() %>">详细</a></td>
</tr>
<%}
} 
}
